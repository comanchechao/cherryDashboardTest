          ...
          <div className="z-10 flex flex-col   w-full relative   ">
            ...
            <div className="w-full flex lg:flex-row flex-col ">
              ...
              <div className="w-full px-10 lg:px-44 my-3">
                <div className="relative rounded-2xl border-4 border-[var(--color-accent)] overflow-hidden   transform hover:-translate-y-2 transition-all duration-300">
                  ...
                  <div className="absolute bottom-0 z-30 left-0 right-0 p-3 bg-[var(--color-glass)]/90 backdrop-blur-sm border-t-2 border-[var(--color-accent)] flex flex-col md:flex-row justify-between items-center gap-4">
                    <button
                      className="bg-[var(--color-accent)] text-white py-1 px-3 rounded-xl border border-b-4 border-r-4 border-[var(--color-accent)] hover:border-b-2 hover:border-r-2 hover:translate-y-1 hover:translate-x-1 transition-all duration-200 transform-gpu hover:  winky-sans-font flex items-center gap-2 whitespace-nowrap"
                      onClick={() =>
                        window.open(
            ...
            <div className="mt-12 flex flex-wrap justify-center gap-4">
              <div className="feature-tag px-6 py-3 bg-[var(--color-glass)] rounded-full border-2 border-[var(--color-accent)]   flex items-center gap-2 transition-all duration-200">
                <Icon
                  icon="mdi:robot"
            ...
            <div className="w-full flex mt-20 items-center justify-center">
              <button
                ...
                className="bg-[var(--color-accent)] text-white py-3 px-6 rounded-xl border border-b-4 border-r-4 border-[var(--color-accent)] hover:border-b-2 hover:border-r-2 hover:translate-y-1 hover:translate-x-1 transition-all duration-200 transform-gpu   hover:  winky-sans-font flex items-center justify-center gap-2"
              >
