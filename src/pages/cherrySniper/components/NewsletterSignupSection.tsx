  ...
  return (
    <div className="section_sniper_spotlight py-5 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-[var(--color-glass)] border border-[var(--color-glass-border)] rounded-[4px] p-8 relative overflow-hidden hover:rotate-0 transition-all duration-300 hover:shadow-[0_20px_40px_rgba(67,103,201,0.2)]">
          ...
          <div className="relative z-10 text-center">
            ...
            <p className="winky-sans-font md:text-lg text-sm text-[var(--color-text-secondary)] mb-8 max-w-2xl mx-auto">
              Get the latest updates, new features, and exclusive insights about
              SniperAI Bot. Be the first to know about upcoming improvements and
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              ...
              >
                ...
                <Icon
                  icon={isSubscribing ? "mdi:loading" : "mdi:email"}
                  width={20}
                  height={20}
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              <div className="flex items-center justify-center gap-2 text-[var(--color-text-secondary)]">
                <Icon
                  ...
                  height={16}
                />
                <span className="winky-sans-font">Latest Updates</span>
              </div>
              <div className="flex items-center justify-center gap-2 text-[var(--color-text-secondary)]">
                <Icon
                  icon="mdi:star"
              ...
              <div className="flex items-center justify-center gap-2 text-[var(--color-text-secondary)]">
                <Icon
                  ...
                  height={16}
                />
                <span className="winky-sans-font">Trading Tips</span>
              </div>
            </div>
          </div>
        </div>
