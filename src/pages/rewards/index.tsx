        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl winky-sans-font text-[var(--color-text-secondary)] mb-8 max-w-4xl mx-auto">
              Earn points, unlock achievements, and get rewarded for trading
              with SniperAI Bot
            </p>
          </div>
                  ...
                  <button
                    ...
                    className={`px-6 py-3 rounded-xl winky-sans-font font-medium transition-all duration-200 flex items-center gap-2 ${
                      activeTab === "leaderboard"
                        ? "bg-black text-white shadow-[2px_2px_0px_#121a2a] transform translate-y-0.5"
